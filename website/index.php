                ...
                <div class="col-sm-4 mb-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="karmatop.php" class="btn btn-outline-primary">Zur Karmatop</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-4 mb-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="https://discord.com/api/oauth2/authorize?client_id=803579214553022484&permissions=8&scope=bot" class="btn btn-outline-primary">Zum Discordbot</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-4 mb-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Auf dieser Website findest du die Karmatop Liste, welche alle Spieler die auf dem Timolia Achievment Community beinhaltet, und deren Karma auflistet. Wenn du mehr erfahren möchtest oder eine Frage hast, dann komm doch einfach auf den Timolia Achievment Community Discord</p>
                            <a href="https://discord.gg/t9Jny6ds3E" class="btn btn-outline-primary">Discord Server beitreten</a>
                        </div>
                    </div>
                </div>
